<div align="center">
  <img src="assets/hero.svg" alt="Thalha — security researcher and tool engineer. I build local-first security tooling that returns answers you can verify." width="100%">
</div>
